...
.. toctree::
    ...
    Basic Installation <basic_install>

Quick start
===========

To quickly install the latest AIMET for PyTorch framework, see :ref:`Quick Start <install-quick-start>`.

Installation
============

To install latest AIMET for all framework variants and compute platform, see :ref:`Basic installation <install-basic-install>`.
